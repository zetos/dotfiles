Config
  { font = "Iosevka 9",
    ...
    sepChar = "%",
    alignSep = "}{",
    template = "%StdinReader% }{ <fn=1>layout</fn> %kbd% <fc=#4C566A>|</fc> %enp4s0% <fc=#4C566A>|</fc> %multicpu% <fc=#4C566A>|</fc> %memory% <fc=#4C566A>|</fc> <fn=1>vol</fn> %vol% <fc=#4C566A>|</fc> %date%%_XMONAD_TRAYPAD% "
  }
